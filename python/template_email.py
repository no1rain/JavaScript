...
ourmailsender = MailSender('no1rain@gmail.com', 'sphinx@2005', ('smtp.gmail.com', 587))
...
ourmailsender.set_message(plaintext, "This is a test", "Adam Admson")
...
ourmailsender.set_recipients(['hanlab@naver.com'])
